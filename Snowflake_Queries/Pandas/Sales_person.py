...
def sales_person(sales_person: pd.DataFrame, company: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
    # Step 1: Join orders with company to find RED company orders
    red_orders = orders.merge(company, on='com_id')
    
    # Step 2: Filter for RED company and get their sales_ids
    red_sales_ids = red_orders[red_orders['name'] == 'RED']['sales_id'].unique()
    
    # Step 3: Find salespersons NOT in that list
...
SalesPerson = pd.DataFrame({
    ...
    "hire_date": pd.to_datetime(['4/1/2006', '5/1/2010', '12/25/2008', '1/1/2005', '2/3/2007'])
})
...
orders = pd.DataFrame({
    "order_id" : [1,2,3,4],
    "order_date" : pd.to_datetime(['1/1/2024','2/1/2024','3/1/2024','4/1/2024']),
    "com_id" : [3,4,1,1],
    "sales_id" : [4,5,1,4],
